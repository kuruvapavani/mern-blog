...
const GettingStarted = (darkMode) => {
  return (
    <div className='ml-5 mt-8 '>
      <h1 style={{fontSize:"2.4rem",textWrap:"wrap"}}>👋 Getting Started</h1>
